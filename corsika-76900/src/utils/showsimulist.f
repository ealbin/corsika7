...
c     files must be available as [DAT,CER]iiiiii, protocol files as
c     [DAT,CER]iiiiii.lst; otherwise additional conditions must be
c     implemented to this source code.
c-----------------------------------------------------------------------
c compilation:
...
c-----------------------------------------------------------------------
      ...
      character cdata(nfmx)*160,cdat*160,csklst*160,czeile*80
...
c - - - - - check on original 64bit simulation and Cerenkov output - - -
