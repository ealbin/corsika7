...
namespace crsRead {
  ...
  */
  ...
  public:
    ...
    inline void SetParticleDataSize (int s) {fParticleDataSize=s;}
    inline void SetBlockSize (int s) {fBlockSize=s;}
    ...
    inline int  GetParticleDataSize () const {return fParticleDataSize;}
    inline int  GetBlockSize () const {return fBlockSize;}
  ...
  protected:
    ...
    /// Size of one CORSIKA Particle definition  (7 or 8 REAL*4)
    int   fParticleDataSize;
	
    /// Size of one CORSIKA SubBloc
    int   fBlockSize;      
